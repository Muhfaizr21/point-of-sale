...
export const KontakPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('Pesan Anda telah terkirim. Tim kami akan menghubungi Anda dalam 1×24 jam.');
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 rounded-2xl p-6 md:p-8 border border-zinc-800" style={{ backgroundColor: '#0a0a0a' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button type="submit"
                className="inline-flex items-center gap-2 px-8 py-3.5 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-500 transition-all shadow-lg shadow-indigo-900/30">
